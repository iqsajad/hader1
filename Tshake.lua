...
if hash or DevTWIX(msg) or DevBot(msg) then 
return true 
else 
return false 
end 
...
if hash or DevTWIX(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevTWIX(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevTWIX(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or DevTWIX(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
end
function CleangGroups();local z = io.open('./TWIX');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/TWIX.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
...
local UserName = (data.username_ or "TWIXTEAM")
for TWIX in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = TWIX
end
local NameUser = "⸙ ¦ بواسطه‍ 𓄂 ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "⸙ ¦ العضو 𓄂 ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
local url,res = http.request('http://TWIX.ml/joinch/?id='..msg.sender_user_id_)
...
send(msg.chat_id_, msg.id_,"\n⸙ ¦ العضو 𓄂 ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n⸙ ¦ تم رفعه "..RTPA.." هنا\n")   
...
if TWIXrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n⸙ ¦ العضو 𓄂 ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n⸙ ¦ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."TWIX:Special:User"..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_, '⸙ ¦ تم تعطيل 𓄂 الحظر ~ والطرد ')
return false
end
end
...
send(msg.chat_id_, msg.id_, '⸙ ¦ تم تفعيل 𓄂 الحظر ~ والطرد ')
return false
end
end
...
send(msg.chat_id_, msg.id_, '⸙ ¦ تم تعطيل رفع 𓄂 الادمن ~ المميز ')
return false
end
end
...
send(msg.chat_id_, msg.id_, '⸙ ¦ تم تفعيل رفع 𓄂 الادمن ~ المميز ')
return false
end
end
...
tt = "\n⸙ ¦ تستطيع اضافة مايلي !\n⸙ ¦ دالة عرض الاسم 𓄂{`name`}\n⸙ ¦ دالة عرض المعرف 𓄂{`user`}"
...
send(msg.chat_id_, msg.id_,"⸙ ¦  تم تغير رد المطور الى 𓄂 "..Teext)
end
...
send(msg.chat_id_, msg.id_,"⸙ ¦  تم تغير رد المنشئ الاساسي الى 𓄂 "..Teext)
end
...
send(msg.chat_id_, msg.id_,"⸙ ¦  رتبتك في البوت 𓄂 "..rtp)
end
if text == "اسمي"  then 
...
database:srem(bot_id.."TWIX:Ban:User"..msg.chat_id_,result.id_)
database:srem(bot_id.."TWIX:Muted:User"..msg.chat_id_,result.id_)
usertext = "\n⸙ ¦  العضو 𓄂 ["..result.title_.."](t.me/"..(username or "x_xxax")..")"
status  = "\n⸙ ¦  تم الغاء القيود عنه"
...
database:srem(bot_id.."TWIX:Muted:User"..msg.chat_id_,result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = "\n⸙ ¦  العضو 𓄂 ["..data.first_name_.."](t.me/"..(data.username_ or "x_xxax")..")"
status  = "\n⸙ ¦  تم الغاء القيود عنه"
...
send(msg.chat_id_, msg.id_,"⸙ ¦  الحظر العام 𓄂 "..GBan.."\n⸙ ¦ الحظر 𓄂 "..Ban.."\n⸙ ¦  الكتم 𓄂 "..Muted)
else
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"𓍯┇ لا توجد ادمنية ليتم رفعهم") 
else
...
local UserName = (b.username_ or "TWIXTEAM")
...
"\n⸙ ¦ علامة ال {✘} تعني معطل"..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\n⸙ ¦ الروابط 𓄂 "..lock_links..
"\n".."⸙ ¦ المعرفات 𓄂 "..lock_user..
"\n".."⸙ ¦ التاك 𓄂 "..lock_hash..
"\n".."⸙ ¦ البوتات 𓄂 "..lock_bots..
"\n".."⸙ ¦ التوجيه 𓄂 "..lock_fwd..
"\n".."⸙ ¦ التثبيت 𓄂 "..lock_pin..
"\n".."⸙ ¦ الاشعارات 𓄂 "..lock_tagservr..
"\n".."⸙ ¦ الماركدون 𓄂 "..lock_mark..
"\n".."⸙ ¦ التعديل 𓄂 "..lock_edit..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\n".."⸙ ¦ الكلايش 𓄂 "..lock_spam..
"\n".."⸙ ¦ الكيبورد 𓄂 "..lock_inlin..
"\n".."⸙ ¦ الاغاني 𓄂 "..lock_vico..
"\n".."⸙ ¦ المتحركه 𓄂 "..lock_gif..
"\n".."⸙ ¦ الملفات 𓄂 "..lock_file..
"\n".."⸙ ¦ الدردشه 𓄂 "..lock_text..
...
local message_edit = database:get(bot_id..'TWIX:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."TWIX:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'TWIX:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
if text and text:match('^تنظيف (%d+)$') and DevTWIXe(msg) then    
...
local Num_Games = database:get(bot_id.."TWI:Msg_User"..msg.chat_id_..":"..data.id_) or 0
...
if database:get(bot_id.."TWI:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."TWI:Set:Sma"..msg.chat_id_)
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","🍵","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","🎭","🎪","🎟","🎫","🎗","🏵","🎖","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","📌","📍","📓","📗","📂","📅","📪","📫","📬","📭","⏰","📺","🎚","☎️","⸙"}
SM = Random[math.random(#Random)]
database:set(bot_id.."TWI:Random:Sm"..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_,"⸙ ¦ اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
end
if text == ""..(database:get(bot_id.."TWI:Random:Sm"..msg.chat_id_) or "").."" and not database:get(bot_id.."TWI:Set:Sma"..msg.chat_id_) then
if not database:get(bot_id.."TWI:Set:Sma"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"⸙ ¦ الف مبروك لقد فزت \n⸙ ¦ للعب مره اخره ارسل ~{ سمايل , سمايلات }")
database:incrby(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TWI:Set:Sma"..msg.chat_id_,true)
return false
end 
if text == "الاسرع" or tect == "ترتيب" then
if database:get(bot_id.."TWI:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."TWI:Speed:Tr"..msg.chat_id_)
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
database:set(bot_id.."TWI:Klam:Speed"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."TWI:Klam:Speed"..msg.chat_id_) or "").."" and not database:get(bot_id.."TWI:Speed:Tr"..msg.chat_id_) then
if not database:get(bot_id.."TWI:Speed:Tr"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"⸙ ¦ الف مبروك لقد فزت \n⸙ ¦ للعب مره اخره ارسل ~{ الاسرع , ترتيب }")
database:incrby(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TWI:Speed:Tr"..msg.chat_id_,true)
end 

if text == "حزوره" then
if database:get(bot_id.."TWI:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."TWI:Set:Hzora"..msg.chat_id_)
Hzora = {"الجرس","عقرب الساعه","السمك","المطر","5","الكتاب","البسمار","7","الكعبه","بيت الشعر","لهانه","انا","امي","الابره","الساعه","22","غلط","كم الساعه","البيتنجان","البيض","المرايه","الضوء","الهواء","الضل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","بلم"};
name = Hzora[math.random(#Hzora)]
database:set(bot_id.."TWI:Klam:Hzor"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."TWI:Klam:Hzor"..msg.chat_id_) or "").."" and not database:get(bot_id.."TWI:Set:Hzora"..msg.chat_id_) then
if not database:get(bot_id.."TWI:Set:Hzora"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"⸙ ¦ الف مبروك لقد فزت \n⸙ ¦ للعب مره اخره ارسل ~{ حزوره }")
database:incrby(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TWI:Set:Hzora"..msg.chat_id_,true)
end 

if text == "معاني" then
if database:get(bot_id.."TWI:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."TWI:Set:Maany"..msg.chat_id_)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
database:set(bot_id.."TWI:Maany"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."TWI:Maany"..msg.chat_id_) or "").."" and not database:get(bot_id.."TWI:Set:Maany"..msg.chat_id_) then
if not database:get(bot_id.."TWI:Set:Maany"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"⸙ ¦ الف مبروك لقد فزت \n⸙ ¦ للعب مره اخره ارسل ~{ معاني }")
database:incrby(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TWI:Set:Maany"..msg.chat_id_,true)
end 
if text == "العكس" then
if database:get(bot_id.."TWI:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."TWI:Set:Aks"..msg.chat_id_)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
database:set(bot_id.."TWI:Set:Aks:Game"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."TWI:Set:Aks:Game"..msg.chat_id_) or "").."" and not database:get(bot_id.."TWI:Set:Aks"..msg.chat_id_) then
if not database:get(bot_id.."TWI:Set:Aks"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"⸙ ¦ الف مبروك لقد فزت \n⸙ ¦ للعب مره اخره ارسل ~{ العكس }")
database:incrby(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TWI:Set:Aks"..msg.chat_id_,true)
end 

if database:get(bot_id.."TWI:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
send(msg.chat_id_, msg.id_,"⸙ ¦ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
local GETNUM = database:get(bot_id.."TWI:GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."TWI:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."TWI:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
database:incrby(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_,5)  
send(msg.chat_id_, msg.id_,"⸙ ¦ مبروك فزت ويانه وخمنت الرقم الصحيح\n⸙ ¦ تم اضافة { 5 } من النقاط \n")
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:incrby(bot_id.."TWI:SADD:NUM"..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(database:get(bot_id.."TWI:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)) >= 3 then
database:del(bot_id.."TWI:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."TWI:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
database:set(bot_id.."TWI:GAMES:NUM"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,"\n⸙ ¦ اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n".."⸙ ¦ ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."⸙ ¦ سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
database:setex(bot_id.."TWI:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end

if database:get(bot_id.."TWI:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
send(msg.chat_id_, msg.id_,"⸙ ¦ عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."TWI:Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."TWI:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"⸙ ¦ مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n🎊┇لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
database:incrby(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."TWI:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"⸙ ¦ للاسف لقد خسرت \n⸙ ¦ المحيبس بل ايد رقم { "..GETNUM.." }\n𓍯┇حاول مره اخرى للعثور على المحيبس")
end
end
end
...
if database:get(bot_id.."TWI:Lock:Games"..msg.chat_id_) then   
Num = math.random(1,6)
database:set(bot_id.."TWI:Games:Bat"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
database:setex(bot_id.."TWI:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
...
database:del(bot_id.."TWI:Set:Moktlf:Bot"..msg.chat_id_)
database:set(bot_id.."TWI::Set:Moktlf"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."TWI::Set:Moktlf"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."TWI:Set:Moktlf:Bot"..msg.chat_id_) then 
database:del(bot_id.."TWI::Set:Moktlf"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"⸙ ¦ الف مبروك لقد فزت \n⸙ ¦ للعب مره اخره ارسل ~{ المختلف }")
database:incrby(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TWI:Set:Moktlf:Bot"..msg.chat_id_,true)
end
if text == "امثله" then
if database:get(bot_id.."TWI:Lock:Games"..msg.chat_id_) then
mthal = {"جوز","ضراطه","الحبل","الحافي","شقره","بيدك","سلايه","النخله","الخيل","حداد","المبلل","يركص","قرد","العنب","العمه","الخبز","بالحصاد","شهر","شكه","يكحله",};
name = mthal[math.random(#mthal)]
database:set(bot_id.."TWI:Set:Amth"..msg.chat_id_,name)
database:del(bot_id.."TWI:Set:Amth:Bot"..msg.chat_id_)
...
if text == ""..(database:get(bot_id.."TWI:Set:Amth"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."TWI:Set:Amth:Bot"..msg.chat_id_) then 
database:del(bot_id.."TWI:Set:Amth"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"⸙ ¦ الف مبروك لقد فزت \n⸙ ¦ للعب مره اخره ارسل ~{ امثله }")
database:incrby(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TWI:Set:Amth:Bot"..msg.chat_id_,true)
end
if text == "تعطيل الالعاب" and Owner(msg) then   
database:del(bot_id.."TWI:Lock:Games"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"\n⸙ ¦ تم تعطيل الالعاب") 
end
if text == "تفعيل الالعاب" and Owner(msg) then  
database:set(bot_id.."TWI:Lock:Games"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"\n⸙ ¦ تم تفعيل الالعاب") 
end
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
⸙ ¦ مجوهراتي 𓄂 لعرض عدد الارباح
⸙ ¦ بيع مجوهراتي + العدد 𓄂 لستبدال كل مجوهره ب50 رساله
]]
...
local Num = database:get(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
if Num == 0 then 
...
if tonumber(database:get(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,"⸙ ¦ ليس لديك جواهر من الالعاب \n⸙ ¦ اذا كنت تريد ربح الجواهر \n⸙ ¦ ارسل الالعاب وابدأ اللعب ! ") 
else
local NUM_GAMES = database:get(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,"\n⸙ ¦ ليس لديك جواهر بهاذا العدد \n⸙ ¦ لزيادة مجوهراتك في اللعبه \n⸙ ¦ ارسل الالعاب وابدأ اللعب !") 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id.."TWI:Add:Num"..msg.chat_id_..msg.sender_user_id_,NUMPY)  
...
if database:get(bot_id.."TWI:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."TWI:id:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "⸙ ¦ تم الغاء الامر ") 
database:del(bot_id.."TWI:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."TWI:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."TWI:id:user"..msg.chat_id_)  
database:del(bot_id.."TWI:Msg_User"..msg.chat_id_..":"..msg.sender_user_id_) 
...
if database:get(bot_id.."TWI:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."TWI:idgem:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "⸙ ¦ تم الغاء الامر ") 
database:del(bot_id.."TWI:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."TWI:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."TWI:idgem:user"..msg.chat_id_)  
database:incrby(bot_id.."TWI:Add:Num"..msg.chat_id_..iduserr,numadded)  
send(msg.chat_id_, msg.id_,"⸙ ¦ تم اضافة له {"..numadded.."} من المجوهرات")  
end
------------------------------------------------------------
if text and text:match("^اضف رسائل (%d+)$") and msg.reply_to_message_id_ == 0 and Constructor(msg) then    
taha = text:match("^اضف رسائل (%d+)$")
database:set(bot_id.."TWI:id:user"..msg.chat_id_,taha)  
database:setex(bot_id.."TWI:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:set(bot_id.."TWI:idgem:user"..msg.chat_id_,taha)  
database:setex(bot_id.."TWI:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:incrby(bot_id.."TWI:Add:Num"..msg.chat_id_..result.sender_user_id_,Num)  
...
function reply(extra, result, success)
database:del(bot_id.."TWI:Msg_User"..msg.chat_id_..":"..result.sender_user_id_) 
...
print('\27[30;33m𓄂𓄂 THE USER IS SAVE ME ↓\n𓄂𓄂 '..pv[i]..'\n\27[1;37m')
else
print('\27[30;31m𓄂𓄂 THE USER IS BLOCK ME ↓\n𓄂𓄂 '..pv[i]..'\n\27[1;37m')
...
print('\27[30;34m𓄂𓄂 THE BOT IS NOT ADMIN ↓\n𓄂𓄂 '..group[i]..'\n\27[1;37m')
...
database:srem(bot_id..'TWIX:Chek:Groups',group[i])  
q = q + 1
print('\27[30;35m𓄂𓄂 THE BOT IS LEFT GROUP ↓\n𓄂𓄂 '..group[i]..'\n\27[1;37m')
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusKicked" then
database:srem(bot_id..'TWIX:Chek:Groups',group[i])  
q = q + 1
print('\27[30;36m𓄂𓄂 THE BOT IS KICKED GROUP ↓\n𓄂𓄂 '..group[i]..'\n\27[1;37m')
end
...
download_to_file('https://raw.githubusercontent.com/TWIXab/TWIX/master/TWIX.lua', 'TWIX.lua') 
download_to_file('https://raw.githubusercontent.com/TWIXab/TWIX/master/start.lua', 'start.lua') 
dofile('TWIX.lua')  
return false
end
...
if DevTWIX(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TWIXab/files_TWIX/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⸙ ¦ اهلا بك في متجر ملفات تويكس \n⸙ ¦ الملفات الموجوده حاليا \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n\n"
...
NumFile = NumFile + 1
TextS = TextS..'*'..NumFile.."~⪼* {`"..name..'`} 𓄂 '..CeckFile..'\n[- File Information]('..Info..')\n'
end
...
t = "*⸙ ¦  بالتاكيد تم تعطيل وحذف ملف 𓄂 {"..file.."} \n✓*"
end
local json_file, res = https.request("https://raw.githubusercontent.com/TWIXab/files_TWIX/master/files_TWIX/"..file)
if res == 200 then
...
if file_bot then
io.close(file_bot)
t = "*⸙ ¦  بالتاكيد تم تنزيل وتفعيل ملف 𓄂 {"..file.."} \n✓*"
else
...
if text == 'حظر' then
sendText(Id_Sudo,'⸙ ¦ لشخص 𓄂 ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n⸙ ¦  تم حظره من التواصل ',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'BaN:In:User',data.id_)  
return false  
end 
if text =='الغاء الحظر' then
sendText(Id_Sudo,'⸙ ¦ الشخص 𓄂 ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n⸙ ¦  تم الغاء حظره من التواصل ',msg.id_/2097152/0.5,'md')
...
local Name_Bot = (database:get(bot_id.."TWIX:Name:Bot") or "تويكس")
...
print('\27[30;32m𓄂𓄂 يرجى الاننتضار لحين تنظيف المجموعات الوهميه ««\n\27[1;37m')
local list = database:smembers(bot_id..'TWIX:UsersBot')  
for k,v in pairs(list) do 
